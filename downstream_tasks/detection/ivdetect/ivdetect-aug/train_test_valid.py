...
vul_partition = int(len_vul)
nonvul_partition = int(0.9 * len_nonvul)
train_list = vul_list[:vul_partition] + nonvul_list[:vul_partition]
random.shuffle(train_list)
#non_vul_valid = int(int(0.1 * len_nonvul) * ratio)

valid_list = vul_list[vul_partition:] + nonvul_list[nonvul_partition:]

#valid_list = vul_list[vul_partition:vul_partition + int(0.1 * len_vul)] + nonvul_list[
#                                                                          nonvul_partition:nonvul_partition + non_vul_valid]
random.shuffle(valid_list)
#test_list = vul_list[vul_partition + int(0.1 * len_vul):] + nonvul_list[
#                                                            nonvul_partition + non_vul_valid:nonvul_partition + non_vul_valid + non_vul_valid]
