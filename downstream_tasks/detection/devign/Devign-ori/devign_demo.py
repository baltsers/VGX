...
if __name__ == '__main__':
    ...
    if os.path.exists(processed_data_path):
        ...
        dataset = DataSet(train_src=['devign_for_vulgen.json.shard1', 'devign_for_vulgen.json.shard2', 'devign_for_vulgen.json.shard3', 'devign_for_vulgen.json.shard4', 'devign_for_vulgen.json.shard5'],
